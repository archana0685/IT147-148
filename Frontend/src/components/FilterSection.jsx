      ...
      <Wrapper>
          ...
          <div>
            {
              categoryData.map((curElem, index) => {
                return (<button key={index} type='button' name='category' value={curElem} className={curElem === category ? "active" : ""} onClick={updateFilterValue}>{curElem}</button>);
              })
            }
          </div>
        </div>
        ...
        <div className="filter-colors colors">
              ...
              <div className="filter-color-style">
                {
                  colorsData.map((curElem,index) => {
                    ...
                    if(curElem === "all")
                    {
                      ...
                      type='button' className='color-all--style'
                    ...
                    return (<button key={index}
                      type='button' style={{ backgroundColor : curElem}} className={color === curElem ? "btnStyle active" : "btnStyle"}
                      onClick={updateFilterValue}
                      value={curElem}
                      name='color'
                    >
              ...
              <div className="filter_price">
                ...
                <input type="range" min={minPrice} max={maxPrice} value={price} onChange={updateFilterValue} name='price' />
              </div>
