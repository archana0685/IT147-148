...
const UpdateProduct = () => {
    ...
    const [selectedGender, setSelectedGender] = useState(singleProduct.gender);
    ...
    const [sizes, setSizes] = useState(singleProduct.product_sizes);
    const [size, setSize] = useState("");
    const [stock, setStock] = useState();
    const [price, setPrice] = useState();
    const [color, setColor] = useState(singleProduct.color);

  const [storeImages, setStoreImages] = useState(singleProduct.image);
  const [images, setImages] = useState(singleProduct.image);
...
<AiFillDelete style={{ cursor: "pointer" }} onClick={(e) => {
                        ...
                        return (
                          ...
                          <td key={index}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", width : "5rem" }}>
                              ...
                              <div style={{ display: "flex", flexDirection: "row", gap: "1.7rem", width : "5rem"}}>
...

                              {
                                 ...
                                 typeof(ele.imgUrl) === "string" ? (<img src={ele.imgUrl} alt="" style={{ width: "5rem" }} />) : (<img src={URL.createObjectURL(ele.imgUrl)} alt="" style={{ width: "5rem" }} />)
                              }
          ...
          <div className="form-group">
            ...
            {
              file !== undefined ? <span style={{ marginLeft: "1rem" }}>{file.name}</span> : (<span style={{ marginLeft: "1rem" }}>No file uploaded</span>)
            }
